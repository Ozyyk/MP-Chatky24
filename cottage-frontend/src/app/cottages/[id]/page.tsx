...
//         <div className="w-full h-96 bg-cover bg-center rounded-b-lg shadow-lg" style={{ backgroundImage: `url(${cottage.image_urls[0]})` }}></div>
//       )}
...
//               <img key={index} src={url} alt={`Další obrázek ${index + 1}`} className="rounded-lg shadow-md w-full h-48 object-cover" />
//             ))}
//           </div>
//         </div>
